...
Experiment_name="VFace"
device=0

CONFIG="REFace/models/REFace/configs/project_ffhq.yaml"
DATA_CONFIG="dataset/FaceData/Data/VFHQ-Test/data_matching.yaml"
CKPT="models/REFace/checkpoints/last.ckpt"


video_base_dir="dataset/FaceData/Data/VFHQ-Test/GT/Vid_Interval1_512x512_LANCZOS4"
image_dir="dataset/FaceData/Data/VFHQ-Test/Celeb_Source"
...
CUDA_VISIBLE_DEVICES=${device} python scripts/VFace_inference_batch.py \
    --config "${CONFIG}" \
    --ckpt "${CKPT}" \
